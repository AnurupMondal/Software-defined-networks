...
%   Copyright 2012-2013 David Hock, Stefan Gei�ler, Fabian Helmschrott,
%                       Steffen Gebert
%                       Chair of Communication Networks, Uni W�rzburg   
%

function [topology,latlong,nodenames,distanceMatrix,P]=importGraphML(filename)
...
[distanceMatrix P]=allToAllPathMatrix(goodIdx,latlong,edges);
